...
def parse_arguments():
    ...
    parser.add_argument("--workers", type=int, default=15, help="how many cpu workers")
    parser.add_argument(
        "--output-size",
        type=int,
        default=40,
    ...
    parser.add_argument(
        "--dataset", type=str, help="name of dataset", choices=['mnist', 'cifar10', 'cifar100', 'timgnet']
    )
    parser.add_argument(
        "--log-dir",
        type=str,
    ...
    # parser.add_argument("--resume", type=str, default='./runs/rn18-supsup/id=supsup~seed=0~sparsity=32~try=0/result_9.pt', help='optionally resume')
    # parser.add_argument("--resume", type=str, default=None, help='optionally resume')
    # parser.add_argument("--resume_task", type=int, default=10)
    ...
    parser.add_argument("--cal_batch_size", type=int, default=15) # I accidently put 15, was planning to use 16
