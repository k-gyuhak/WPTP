...
class Net(BaseModel):
    def __init__(self, num_classes):
        last_dim = 800
        super(Net, self).__init__(last_dim, num_classes)
        builder = Builder()
        ...
        self.fc1 = builder.conv1x1(256, last_dim, last_layer=False)
    ...
    def penultimate(self, x):
        bsz = x.size(0)
        out = self.maxpool(self.drop1(self.conv1(x.view(bsz, 3, 28, 28))))
